'''
Usage:
python3 step7_update_images_labels_with_n_cls.py -n 1 -drp /home/brcao/Repos/datasets/coco
python3 step7_update_images_labels_with_n_cls.py -n 1 -drp /home/brcao/Repos/datasets/coco_minitrain_25k
python3 step7_update_images_labels_with_n_cls.py -n 1 -drp /home/brcao/Data/datasets/coco_minitrain_25k
python3 step7_update_images_labels_with_n_cls.py -n 1 -drp /home/brcao/Data/datasets/coco_datasets_cls_0/coco_minitrain_25k
'''
...
class Config:
    def __init__(self):
        ...
        parser.add_argument('-n_cls', '--number_classes', type=int, default=1)
