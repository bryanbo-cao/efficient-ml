        ...
        for n_cls, name_ls in enumerate(C.cls_name_ls_f.readlines()):
            ...
            if n_cls < 6 or n_cls % 10 == 0:
                ...
                if scale_str == '1o1':
                    ...
                    new_data_yaml_f = open(C.data_yaml_folder + '/' + C.dataset + '_n_cls_' + str(n_cls) + '_v4.yaml', 'w') # edit
                else:
                    ...
                    new_data_yaml_f = open(C.data_yaml_folder + '/' + C.dataset + '_' + scale_str + '_n_cls_' + str(n_cls) + '_v4.yaml', 'w')
