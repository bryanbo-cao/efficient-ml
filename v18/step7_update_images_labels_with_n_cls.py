...
python3 step7_update_images_labels_with_n_cls.py -n 2 -drp /home/brcao/Repos/datasets/coco_train
python3 step7_update_images_labels_with_n_cls.py -n 2 -drp /home/brcao/Data/datasets/coco_train
python3 step7_update_images_labels_with_n_cls.py -n 2 -drp /home/brcao/Data/datasets/coco_datasets_v18/coco_train
'''
...
class Config:
    def __init__(self):
        ...
        parser.add_argument('-n_cls', '--number_classes', type=int, default=2)
