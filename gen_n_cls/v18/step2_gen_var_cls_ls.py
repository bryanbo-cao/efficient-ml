...
python3 step2_gen_var_cls_ls.py -drp /home/brcao/Repos/datasets/coco_train
python3 step2_gen_var_cls_ls.py -dtp /home/brcao/Data/datasets/coco_train
...
if __name__ == '__main__':
    ...
    # [22, 0, 5, 17, 33]: ['zebra', 'person', 'bus', 'horse', 'kite']
    C.cls_ls.append([22])
    C.cls_ls.append([22, 0])
    C.cls_ls.append([22, 0, 5])
    C.cls_ls.append([22, 0, 5, 17])
    C.cls_ls.append([22, 0, 5, 17, 33])
    visited = copy.deepcopy(C.cls_ls[-1])

    C.cls_name_ls.append(['zebra'])
    C.cls_name_ls.append(['zebra', 'person'])
    C.cls_name_ls.append(['zebra', 'person', 'bus'])
    C.cls_name_ls.append(['zebra', 'person', 'bus', 'horse'])
    C.cls_name_ls.append(['zebra', 'person', 'bus', 'horse', 'kite'])
