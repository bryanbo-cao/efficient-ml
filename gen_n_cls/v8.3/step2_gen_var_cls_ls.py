...
if __name__ == '__main__':
    ...
    # [23, 22, 0, 4, 20]: ['giraffe', 'zebra', 'person', 'airplane', 'elephant']
    C.cls_ls.append([23])
    C.cls_ls.append([23, 22])
    C.cls_ls.append([23, 22, 0])
    C.cls_ls.append([23, 22, 0, 4])
    C.cls_ls.append([23, 22, 0, 4, 20])
    visited = copy.deepcopy(C.cls_ls[-1])

    C.cls_name_ls.append(['giraffe'])
    C.cls_name_ls.append(['giraffe', 'zebra'])
    C.cls_name_ls.append(['giraffe', 'zebra', 'person'])
    C.cls_name_ls.append(['giraffe', 'zebra', 'person', 'airplane'])
    C.cls_name_ls.append(['giraffe', 'zebra', 'person', 'airplane', 'elephant'])
