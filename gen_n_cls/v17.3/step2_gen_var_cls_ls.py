...
if __name__ == '__main__':
    ...
    # [6, 5, 2, 7, 1]: ['train', 'bus', 'car', 'truck', 'bicycle']
    C.cls_ls.append([6])
    C.cls_ls.append([6, 5])
    C.cls_ls.append([6, 5, 2])
    C.cls_ls.append([6, 5, 2, 7])
    C.cls_ls.append([6, 5, 2, 7, 1])
    ...
    C.cls_name_ls.append(['train', 'bus', 'car', 'truck'])
    C.cls_name_ls.append(['train', 'bus', 'car', 'truck', 'bicycle'])
