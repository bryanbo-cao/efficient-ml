...
if __name__ == '__main__':
    ...
    # [6, 5, 2, 3, 7]: ['train', 'bus', 'car', 'motorcycle', 'truck']
    C.cls_ls.append([6])
    C.cls_ls.append([6, 5])
    C.cls_ls.append([6, 5, 2])
    C.cls_ls.append([6, 5, 2, 3])
    C.cls_ls.append([6, 5, 2, 3, 7])
    visited = copy.deepcopy(C.cls_ls[-1])

    C.cls_name_ls.append(['train'])
    C.cls_name_ls.append(['train', 'bus'])
    C.cls_name_ls.append(['train', 'bus', 'car'])
    C.cls_name_ls.append(['train', 'bus', 'car', 'motorcycle'])
    C.cls_name_ls.append(['train', 'bus', 'car', 'motorcycle', 'truck'])
