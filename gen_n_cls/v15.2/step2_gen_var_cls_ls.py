...
if __name__ == '__main__':
    ...
    # [5, 6, 7, 2, 3]: ['bus', 'train', 'truck', 'car', 'motorcycle']
    C.cls_ls.append([5])
    C.cls_ls.append([5, 6])
    C.cls_ls.append([5, 6, 7])
    C.cls_ls.append([5, 6, 7, 2])
    C.cls_ls.append([5, 6, 7, 2, 3])
    visited = copy.deepcopy(C.cls_ls[-1])

    C.cls_name_ls.append(['bus'])
    C.cls_name_ls.append(['bus', 'train'])
    C.cls_name_ls.append(['bus', 'train', 'truck'])
    C.cls_name_ls.append(['bus', 'train', 'truck', 'car'])
    C.cls_name_ls.append(['bus', 'train', 'truck', 'car', 'motorcycle'])
