...
if __name__ == '__main__':
    ...
    # [23, 0, 4, 10, 11]: ['giraffe', 'person', 'airplane', 'fire hydrant', 'stop sign']
    C.cls_ls.append([23])
    C.cls_ls.append([23, 0])
    C.cls_ls.append([23, 0 ,4])
    C.cls_ls.append([23, 0, 4, 10])
    C.cls_ls.append([23, 0, 4, 10, 11])
    visited = copy.deepcopy(C.cls_ls[-1])

    C.cls_name_ls.append(['giraffe'])
    C.cls_name_ls.append(['giraffe', 'person'])
    C.cls_name_ls.append(['giraffe', 'person', 'airplane'])
    C.cls_name_ls.append(['giraffe', 'person', 'airplane', 'fire hydrant'])
    C.cls_name_ls.append(['giraffe', 'person', 'airplane', 'fire hydrant', 'stop sign'])
