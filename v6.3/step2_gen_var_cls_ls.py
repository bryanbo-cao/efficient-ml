...
if __name__ == '__main__':
    ...
    # [22, 23, 0, 11, 6]: ['zebra', 'giraffe', 'person', 'stop sign', 'train']
    C.cls_ls.append([22])
    C.cls_ls.append([22, 23])
    C.cls_ls.append([22, 23, 0])
    C.cls_ls.append([22, 23, 0, 11])
    C.cls_ls.append([22, 23, 0, 11, 6])
    visited = copy.deepcopy(C.cls_ls[-1])

    C.cls_name_ls.append(['zebra'])
    C.cls_name_ls.append(['zebra', 'giraffe'])
    C.cls_name_ls.append(['zebra', 'giraffe', 'person'])
    C.cls_name_ls.append(['zebra', 'giraffe', 'person', 'stop sign'])
    C.cls_name_ls.append(['zebra', 'giraffe', 'person', 'stop sign', 'train'])
