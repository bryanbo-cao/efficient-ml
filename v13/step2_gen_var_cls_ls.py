...
if __name__ == '__main__':
    ...
    # [2, 5, 3, 6, 7]: ['car', 'bus', 'motorcycle', 'train', 'truck']
    C.cls_ls.append([2])
    C.cls_ls.append([2, 5])
    C.cls_ls.append([2, 5, 3])
    C.cls_ls.append([2, 5, 3, 6])
    C.cls_ls.append([2, 5, 3, 6, 7])
    visited = copy.deepcopy(C.cls_ls[-1])

    C.cls_name_ls.append(['car'])
    C.cls_name_ls.append(['car', 'bus'])
    C.cls_name_ls.append(['car', 'bus', 'motorcycle'])
    C.cls_name_ls.append(['car', 'bus', 'motorcycle', 'train'])
    C.cls_name_ls.append(['car', 'bus', 'motorcycle', 'train', 'truck'])
